...
public class ShortReservationList extends ArrayList<Reservation> {
	...
	public ShortReservationList() {
		...
		this.add(reservation(NOVEMBER, 6, 2, Customer.HEISENBERG));
		this.add(reservation(NOVEMBER, 10, 3, Customer.DIRAC));
		this.add(reservation(NOVEMBER, 10, 4, Customer.PAULI));
		this.add(reservation(NOVEMBER, 13, 3, Customer.MARCONI));
		this.add(reservation(NOVEMBER, 17, 2, Customer.BORN));
		...
		this.add(reservation(NOVEMBER, 14, 2, Customer.MICHELSON));
